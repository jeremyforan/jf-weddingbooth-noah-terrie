...
#let bleedBox= if bleed {box(stroke: (paint: blue, thickness: .5pt, dash: "dashed"), width: 1.8in, height: 5.8in)} else {}
...
#let photo(img, corner: 3mm, imgWidth: 100%) = {
  box(
...
#let imageBlock(alignment: center, padding: 2mm, images: (
